...
JAMMER_CONFIGS = [
    {"pos": [1.0, 1.0], "speed": 0.2},   # 1体目: 反時計回りに速く動く
    {"pos": [0.0, 0.5], "speed": -0.15}, # 2体目: 時計回りに中くらいの速さで動く
    {"pos": [1.0, 0.5], "speed": 0.1},   # 3体目: 反時計回りにゆっくり動く
    {"pos": [1.0, 0.0], "speed": -0.25}  # 4体目: 時計回りにかなり速く動く
]
"""
