...
TOTAL_EPISODES = 700            # 学習する総エピソード数
...
JAMMER_CONFIGS = [
    {"pos": [1.0, 1.0], "speed": 0.02, "angle": 90},
    {"pos": [0.0, 0.5], "speed": 0.02, "angle": 90},
    {"pos": [1.0, 0.5], "speed": 0.02, "angle": 90},
    {"pos": [1.0, 0.0], "speed": 0.02, "angle": 90}
]
